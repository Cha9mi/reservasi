...
<body>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td><button class='btn btn-primary' onclick='printSingle(\"" . $row['nama'] . "\", \"" . $row['usia'] . "\", \"" . $row['gender'] . "\", \"" . $row['alamat'] . "\", \"" . $row['dokter'] . "\", \"" . $row['tanggal'] . "\", \"" . $row['waktu'] . "\")'>Print</button></td>";
                    echo "</tr>";
                }
            }
    ...
    <script>
        ...
        function printSingle(nama, usia, gender, alamat, dokter, tanggal, waktu) {
            var content = `
