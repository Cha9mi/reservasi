...
<head>
    ...
    <title>Reservsai.On Admin | Reservasi Dokter</title>
            ...
            <div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                        ...
                        <li class="nav-item">
                            <a href="crudPembayaran.php" class="nav-link px-0 align-middle">
                                <i class="bi bi-currency-dollar fs-4"></i> <span class="ms-1 d-none d-sm-inline">Pembayaran</span>
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="col py-3">
                <div class="container">
                    <div class="row">
                        <!-- Welcome Message -->
                        <div class="col">
                            <h2>Selamat Datang di Reservsai.On Admin</h2>
                            <p>Anda dapat mengelola reservasi dokter dan informasi pengguna dengan mudah melalui menu di sebelah kiri.</p>
                        </div>
                    </div>
                    <div class="row">
                        <!-- Cards -->
                        <div class="col-md-4 mb-4">
                            <div class="card">
                                <img src="assets/img/card-image.png" class="card-img-top" alt="...">
                                </div>
                            </div>
                        </div>
